      ...
      {profile && (
        <div className="panel profile-card">
          ...
          <div className="detail-grid">
            <div><span className="detail-label">Student ID</span><span>{profile.studentId}</span></div>
            ...
            <div><span className="detail-label">Phone</span><span>{profile.phone}</span></div>
            <div><span className="detail-label">Department</span><span>{profile.department}</span></div>
            <div><span className="detail-label">Year</span><span>{profile.year}</span></div>
